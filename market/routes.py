    ...
    if request.method == 'POST':
        ...
        if p_item_obj:
            if current_user.can_purchase(p_item_obj):
                ...
                flash(f"Congradulations! You have purchased {p_item_obj.name} for {p_item_obj.price}",category='success')
            else:
                flash(f"You can't buy this item! Not enought money", category='danger')
